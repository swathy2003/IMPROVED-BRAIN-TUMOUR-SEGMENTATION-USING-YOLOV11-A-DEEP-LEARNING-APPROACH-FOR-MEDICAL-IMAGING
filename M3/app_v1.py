...
if uploaded_file is not None:
    ...
    # Perform prediction
    results = model.predict(source=image_np, save=False, conf=0.80)  # Perform inference
    ...
    predicted_classes = [
        ...
        if box.conf >= 0.80  # Ensure confidence is above threshold
    ]
